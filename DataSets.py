...
employee_data = {
    ...
    'department' : ['Software Development', 'Data Science', 'Artificial Intelligence', 'Machine Learning', 'Cloud Computing', 'Cyber Security', 'IT Support', 'Software Development', 'DevOps', 'Software Development', 'Product Management', 'Business Analysis', 'Data Science', 'Web Development', 'Mobile App Development', 'Database Administration', 'Data Science', 'IT Support', 'IT Support', 'Machine Learning'],
